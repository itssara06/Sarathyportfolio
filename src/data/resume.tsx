...
import { AdobeIllustrator } from "@/components/ui/svgs/adobeIllustrator";
import { AdobePhotoshop } from "@/components/ui/svgs/adobePhotoshop";
import { Hotjar } from "@/components/ui/svgs/hotjar";
import { Maze } from "@/components/ui/svgs/maze";
...
export const DATA = {
  ...
  avatarUrl: "/me.png",
  skills: [
    { name: "Collaborative Problem Solving", icon: undefined },
    { name: "User Research", icon: undefined },
    { name: "Wireframing", icon: undefined },
    { name: "Prototyping", icon: undefined },
    { name: "Design Systems", icon: undefined },
    { name: "Usability Testing", icon: undefined },
    { name: "Interaction Design", icon: undefined },
    { name: "Visual Design", icon: undefined },
    { name: "Design Thinking", icon: undefined },
    { name: "Information Architecture", icon: undefined },
  ...
  contact: {
    email: "talktosarathy067@gmail.com",
    tel: "+123456789",
    social: {
      // GitHub: {
      //   name: "GitHub",
